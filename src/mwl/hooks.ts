...
export interface HookWorld {
	...
	readonly units: Readonly<
		Record<string, { readonly hp: number; readonly x: number; readonly y: number; readonly alive: boolean; readonly type?: string; readonly side?: number }>
	>;
...
export function emitHooksDeclaration(references: readonly HookReference[]): string {
	...
	lines.push("import type { AiHook, CommandHook, GeneratorHook, MigrationHook, ModifierHook, PredicateHook } from '@datamoc/mw_games/mwl';");
	lines.push('');

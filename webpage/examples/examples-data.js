...
window.MWG_EXAMPLES = [
	...
	// ---------------------------------------------------------- Level 2: Framework systems
	{
		...
		controls:
			'type, use arrows, or paste Unicode text in the FR pane &nbsp;&middot;&nbsp; <kbd>Esc</kbd> stops editing &nbsp;&middot;&nbsp; <kbd>HP -</kbd>/<kbd>HP +</kbd> change the variable &nbsp;&middot;&nbsp; Play matches each sound cue to its sentence',
	},
	{
		id: 'dialogue',
		level: 2,

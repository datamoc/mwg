...
| Area | Statistics |
| --- | ---: |
| Source | 278 TypeScript files, 43,126 lines, 15 modules |
| Tests | 219 files, 2,054 test cases, 28,390 lines |
| Tools | 35 files, 6,346 lines |
| Examples | 22 runnable examples |
| Roadmap | 296/296 items complete, 0 open |
| API | 277 declaration files |
| Bundle | 987.5 kB raw, 293.1 kB gzip |
| Published dist | 3133.6 kB excluding source maps |

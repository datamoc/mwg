...
| Area | Statistics |
| --- | ---: |
| Source | 249 TypeScript files, 35,943 lines, 15 modules |
| Tests | 182 files, 1,670 test cases, 22,874 lines |
| Tools | 35 files, 6,335 lines |
| Examples | 22 runnable examples |
| Roadmap | 265/293 items complete, 28 open |
| API | 0 declaration files |
| Bundle | 919.5 kB raw, 273.4 kB gzip |
| Published dist | 2707.2 kB excluding source maps |

...
| Area | Statistics |
| --- | ---: |
| Source | 251 TypeScript files, 36,422 lines, 15 modules |
| Tests | 184 files, 1,701 test cases, 23,306 lines |
| Tools | 35 files, 6,335 lines |
| Examples | 22 runnable examples |
| Roadmap | 267/293 items complete, 26 open |
| API | 0 declaration files |
| Bundle | 919.5 kB raw, 273.4 kB gzip |
| Published dist | 2742.8 kB excluding source maps |
